...
<div class="back-button">
        ...
        <p style="margin-left: 10px;">Official File</p>
</div>
    ...
    <div class="row">
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                $picture = $row["photos"];
                $picturePath = "photos/" . $picture; // Assuming $picture contains the file name
    ...
    function confirmLogout() {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = 'offcialfile.php?logout=true';
                }
            });
        }
