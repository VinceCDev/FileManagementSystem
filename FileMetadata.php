...
<body>
    ...
    <div class="header">
      ...
      <div class="profile-icon" onclick="toggleProfileDetails()">
        ...
        <?php
          ...
          <a href="FileMetadata.php" class="a1" id="dashb"><i class="fas fa-server"></i> File Metadata</a>
      ...
      <div class="title-with-icon">
        ...
        <p style="margin-right: 1110px;">File Metadata</p>
      </div>
        
      <?php
        include 'connection.php';

        $sql = "SELECT * FROM official_file";

        if (isset($_GET['query'])) {
            $search_query = $_GET['query'];
            $sql .= " WHERE photos LIKE '%$search_query%'";
        }

        $sqlCount = "SELECT COUNT(*) AS totalOfficials FROM official_file";
        ...
        $sqlCount = "SELECT COUNT(*) AS totalOfficials FROM resident_file";
        $resultCount = $conn->query($sqlCount);
        $rowCount = $resultCount->fetch_assoc();
        $totalOfficialsCount = $rowCount['totalOfficials'];
        ...
        <div class="barangay" style="margin-top: 20px;" id="resident">
            <div class="title-with-icon1">
                <h3 style="width: 100%; margin-right: 1080px;">Resident File</h3>
            </div>
            <hr>
            <div class="heading-and-buttons">
                <div class="show-entries">
                ...
                <div class="search-bar">
                    <p>Search: </p>
                    <input type="text" id="searchInput1" onkeyup="searchResident()" placeholder="Search for names..." style="padding-left: 10px;">
                </div>
            </div>
            <hr>
            <table class="table-no-border">
        ...
        $sqlCount = "SELECT COUNT(*) AS totalOfficials FROM form_file";
        $resultCount = $conn->query($sqlCount);
        $rowCount = $resultCount->fetch_assoc();
        $totalOfficialsCount = $rowCount['totalOfficials'];
        ...
        <div class="barangay" style="margin-top: 20px;" id="form">
            <div class="title-with-icon1">
                <h3>Form File</h3>
            </div>
            <hr>
            <div class="heading-and-buttons">
                ...
                <div class="search-bar">
                    <p>Search: </p>
                    <input type="text" id="searchInput2" onkeyup="searchForm()" placeholder="Search for names..." style="padding-left: 10px;">
                </div>
            </div>
            <hr>
            <table class="table-no-border">
        ...
        $sqlCount = "SELECT COUNT(*) AS totalOfficials FROM document_folder";
        $resultCount = $conn->query($sqlCount);
        $rowCount = $resultCount->fetch_assoc();
        $totalOfficialsCount = $rowCount['totalOfficials'];
        ...
        <div class="barangay" style="margin-top: 20px;" id="activity">
            <div class="title-with-icon1">
                <h3 style="width: 100%; margin-right: 1080px;">Activity File</h3>
            </div>
            <hr>
            <div class="heading-and-buttons">
                <div class="show-entries">
                ...
                <div class="search-bar">
                    <p>Search: </p>
                    <input type="text" id="searchInput3" onkeyup="searchActivity()" placeholder="Search for names..." style="padding-left: 10px;">
                </div>
            </div>
            <hr>
            <table class="table-no-border">
        ...
        $sqlCount = "SELECT COUNT(*) AS totalOfficials FROM profile_file";
        $resultCount = $conn->query($sqlCount);
        $rowCount = $resultCount->fetch_assoc();
        $totalOfficialsCount = $rowCount['totalOfficials'];
        ...
        <div class="barangay" style="margin-top: 20px;" id="profile">
            <div class="title-with-icon1">
                <h3>Profile File</h3>
            </div>
            <hr>
            <div class="heading-and-buttons">
                ...
                <div class="search-bar">
                    <p>Search: </p>
                    <input type="text" id="searchInput4" onkeyup="searchProfile()" placeholder="Search for names..." style="padding-left: 10px;">
                </div>
            </div>
            <hr>
            <table class="table-no-border">
        ...
        $sqlCount = "SELECT COUNT(*) AS totalOfficials FROM file_upload";
        $resultCount = $conn->query($sqlCount);
        $rowCount = $resultCount->fetch_assoc();
        $totalOfficialsCount = $rowCount['totalOfficials'];
        ...
        <div class="barangay" style="margin-top: 20px;" id="file_upload">
            <div class="title-with-icon1">
                <h3>File Upload</h3>
            </div>
            <hr>
            <div class="heading-and-buttons">
                ...
                <div class="search-bar">
                    <p>Search: </p>
                    <input type="text" id="searchInput5" onkeyup="searchUpload()" placeholder="Search for names..." style="padding-left: 10px;">
                </div>
            </div>
            <hr>
            <table class="table-no-border">
        ...
        function searchResident() {
            ...
            table = document.getElementById("resident"); // Replace with your actual table ID
    ...
    if (profileDetailsContainer.style.display === 'block' || profileDetailsContainer.style.display === '') {
        ...
        function searchForm() {
            ...
            filter = input.value.toUpperCase();
            table = document.getElementById("form"); // Replace with your actual table ID
            tr = table.getElementsByTagName("tr");
        ...
        function searchActivity() {
            ...
            filter = input.value.toUpperCase();
            table = document.getElementById("activity"); // Replace with your actual table ID
            tr = table.getElementsByTagName("tr");
        ...
        function searchUpload() {
            ...
            filter = input.value.toUpperCase();
            table = document.getElementById("file_upload"); // Replace with your actual table ID
            tr = table.getElementsByTagName("tr");
        ...
        function confirmLogout() {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = 'FileMetadata.php?logout=true';
                }
            });
        }
    </script>
